...
class FlowerClient(NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        for experience in self.benchmark.train_stream:
            ...
            results_stream_dict.append(
                self.cl_strategy.eval(self.benchmark.test_stream)
            )
        ...
        confusion_matrix = results_stream[
    ...
    def evaluate(self, parameters, config):
        ...
        results = []
        print(
            "------------------------Evaluating Client for Server on Updated Global Model on Test Set--------------------"
        )
